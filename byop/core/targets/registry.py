...
A placeholder for Claude Code is included to show the intended extension
point; it is intentionally not enabled until implemented.
"""
...
ALL_TARGETS: list[type[Target]] = [ZedTarget, PyTarget]
...
#     ...
#
# ALL_TARGETS.append(ClaudeTarget)
